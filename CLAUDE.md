...
- ⏳ RESTE À FAIRE — **CAUSE RACINE des vieux rejets (ASC config, pas le code)** : les 2 abos étaient coincés « Waiting for Review » ORPHELINS (non rattachés à la soumission → paywall vide → boucle 2.1(a)). AVANT de resoumettre : vérifier que les 2 abos apparaissent bien dans « In-App Purchases and Subscriptions » de la version ET sont cochés/soumis AVEC le build (« Number of items submitted » > 1). Relancer le support si besoin (Case ID 102935558738).
