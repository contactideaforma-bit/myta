...
const CONSEILS: Conseil[] = [
  ...
  },
  {
    ...
    steps: [
      { title: '1. Les règles d\'un bon petit-déjeuner', content: 'Un bon petit-déjeuner doit : stabiliser la glycémie pour éviter les fringales de 10h, apporter des protéines pour la satiété, inclure des fibres pour le transit, et te donner de l\'énergie sans pic d\'insuline. La durée idéale : mangez assis, tranquillement, en 15-20 minutes.' },
      ...
      { title: '4. Et si tu n\'as pas faim le matin ?', content: 'Ne force pas. Si tu pratiquez le jeûne intermittent ou que tu n\'as simplement pas faim, attendez. L\'important est d\'avoir un vrai premier repas équilibré quand la faim arrive. Certaines personnes fonctionnent très bien avec un petit-déjeuner léger (café + yaourt) et un déjeuner plus copieux. Écoute ton corps.' },
    ],
    tips: ['Prépare ton petit-déjeuner la veille (overnight oats, œufs durs) pour gagner du temps', 'Un petit-déjeuner protéiné réduit les apports caloriques de 15-20% sur la journée', 'Chewed 20-30 fois chaque bouchée — ça améliore la digestion et la satiété'],
  ...
  },
  {
    ...
    steps: [
      ...
      { title: '4. Le régime méditerranéen : le modèle anti-inflammatoire', content: 'Le régime méditerranéen est le plus étudié et validé scientifiquement. Ses principes : abondance de légumes, fruits, légumineuses, noix, céréales complètes. Huile d\'olive comme corps gras principal. Poisson 2-3 fois par semaine. Viande rouge limitée à 1-2 fois par semaine. Peu d\'aliments transformés. Un verre de vin rouge optionnel. Des études montrent une réduction de 30% du risque cardiovasculaire.' },
    ],
