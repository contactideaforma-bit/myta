...
export default function AccountPage() {
  ...
  // App iOS : aucune UI d'achat/paiement/renvoi (modèle "Netflix", Apple 3.1.3(b))
    ...
    <div className="flex flex-col gap-5 pb-10">
      ...
      <Section title="Mon forfait" icon={<Crown size={16} />}>
        <div className="flex flex-col gap-3">
          ...
          {/* iOS (modèle "Netflix", Apple 3.1.3(b)) : aucune UI d'achat, de
              changement de forfait, de gestion de paiement ni de renvoi. L'app
              affiche seulement le statut du compte (badge ci-dessus). */}
