...
const TIPS_POOL: DailyTip[] = [
  ...
  },
  {
    ...
    body: "Dormir moins de 7h augmente la ghréline (hormone de la faim) et réduit la leptine (satiété). La qualité du sommeil est un levier de perte de poids.",
    source: 'Sleep, 2023',
  },
  ...
  },
  {
    ...
    body: "Pour un effort de plus de 90 min, consomme 30 à 60g de glucides par heure. La banane, les dattes ou les gels restent des classiques efficaces.",
  },
  ...
  },
  {
    ...
    body: "Les oméga-3 (poissons gras, noix, lin) réduisent l'inflammation, améliorent la récupération musculaire et soutiennent le cerveau. 2 à 3 portions de poisson gras par semaine suffisent.",
  },
  {
  ...
  },
  {
    ...
    body: "Un paquet par jour représente environ 3 600 €/an. Après 1 mois sans fumer, tu as économisé environ 300 €. Qu'est-ce que tu pourrais t'offrir ?",
  },
  {
  ...
  },
  {
    ...
    body: "Myrtilles, cerises, saumon, huile d'olive, noix, épinards et thé vert sont tes alliés. Idéalement 2 à 3 de ces aliments chaque jour.",
  },
  ...
  {
    key: 'magnesium', emoji: '🥜', tags: ['general'],
  ...
  },
  {
    ...
    body: "Une fenêtre de jeûne nocturne de 12h (ex: 20h à 8h) améliore la sensibilité à l'insuline et favorise l'autophagie. Simple et sans contraintes.",
